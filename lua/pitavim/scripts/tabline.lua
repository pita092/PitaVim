...
function M.MyTabLine()
  ...
  for i = 1, vim.fn.tabpagenr("$") do
    ...
    s = s .. "%#TabLineIconBg#" .. icon_hl .. label.icon .. "%#TabLineIconBg# " .. tab_hl .. label.text
...
function M.ClearHighlight()
  ...
  vim.cmd('lua vim.api.nvim_set_hl(0, "WarningMsg", { fg = "#fabd2f", bg = "NONE" })')
  vim.cmd('lua vim.api.nvim_set_hl(0, "ErrorMsg", { fg = "#Fb4934", bg = "NONE" })')
  vim.cmd('lua vim.api.nvim_set_hl(0, "TabLineIconBg", { bg = "#3c3936" })') -- New highlight for icon background
  return ""
end
