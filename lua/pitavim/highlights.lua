...
vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeNormal", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeNormalNC", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeEndOfBuffer", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeFloatNormal", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeFloatBorder", { bg = "#3c3836" })
vim.api.nvim_set_hl(0, "NeoTreeTitleBar", { fg = "#ffffff", bg = "#3c3836" })
